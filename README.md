...
## Workflow B
* A given area analyzed by Workflow A (typically 1 km<sup>2</sup> tile), or selected independently, can be analyzed in Workflow B to reclassify the area at 1-m spatial resolution by slope, aspect and at 30-m by fuels conditions into areas of expected theoretical fire intensity.  
